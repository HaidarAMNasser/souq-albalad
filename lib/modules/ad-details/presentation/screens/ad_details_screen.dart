        ...
        listener: (context, productState) {
          if (productState is ProductDetailsSuccess) {
            ...
            context.read<StoreDetailsCubit>().fetchStoreDetails(
                  productState.productData.product.addedBy,
                );
            print(
                "HEREEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE");
          }
                                ...
                                children: [
                                  ...
                                  BlocConsumer<ChatDestBloc, ChatDestState>(
                                    ...
                                    if (chatState.newlyCreatedChat != null) {
                                      print(
                                          "NAVIGATION: Chat is ready, navigating now...");
                                    ...
                                    return BlocBuilder<StoreDetailsCubit,
                                            StoreDetailsState>(
                                        builder: (context, storeState) {
                                      return Expanded(
                                          child: storeState
                                                  is StoreDetailsSuccess
                              ...
                              Builder(builder: (context) {
                                ...
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(12.r),
                                    border:
                                        Border.all(color: AppColors.primary2),
                                  ),
                                  child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
