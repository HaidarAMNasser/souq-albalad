...
class BicycleFormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        _buildRadioRow(AppLocalization.of(context).translate('type'), [
          CustomRadioOption(
            label: AppLocalization.of(context).translate('electric'),
            value: 'electric',
            groupValue: gearType,
            onChanged: setGearType,
          ),
          CustomRadioOption(
            label: AppLocalization.of(context).translate('air'),
            value: 'antenna',
            groupValue: gearType,
            onChanged: setGearType,
          ),
