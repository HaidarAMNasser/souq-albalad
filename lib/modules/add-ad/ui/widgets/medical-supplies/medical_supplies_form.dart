...
class MedicalSuppliesFormSection extends StatelessWidget {
  ...
  const MedicalSuppliesFormSection({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('model_or_size'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('purchase_or_manufacture_year'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('material'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('weight_or_max_load'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('compatible_cars'),
        ),
        SizedBox(height: 12.h),
        CustomDropdown(
