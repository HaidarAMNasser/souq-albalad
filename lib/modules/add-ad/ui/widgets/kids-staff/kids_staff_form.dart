...
class KidsStaffFormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CustomDropdown(
          hint: AppLocalization.of(context).translate('choose_category'),
          value: null,
          items: [
            AppLocalization.of(context).translate('toys'),
            AppLocalization.of(context).translate('baby_strollers'),
            AppLocalization.of(context).translate('baby_seats'),
          ],
          onChanged: (_) {},
        ),
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('suitable_age_group'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('product_condition_details'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
