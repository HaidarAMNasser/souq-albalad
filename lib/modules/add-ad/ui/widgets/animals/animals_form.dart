...
class AnimalsFormSection extends StatelessWidget {
      ...
      children: [
        CustomDropdown(
          ...
          items: [
            ...
            AppLocalization.of(context).translate('baby_cars'),
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('appropriate_age'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
