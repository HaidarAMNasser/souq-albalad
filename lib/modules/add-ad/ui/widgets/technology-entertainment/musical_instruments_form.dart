...
class MusicalInstrumentsFormSection extends StatelessWidget {
  ...
  const MusicalInstrumentsFormSection({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('instrumentType')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('brand')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('model')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('color')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('manufactureYearOrPurchase')),
        SizedBox(height: 12.h),
        CustomDropdown(
          hint: tr('accessories'),
          value: null,
        ...
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('warranty')),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('fullAddress')),
        SizedBox(height: 12.h),
        GestureDetector(
          onTap: pickImages,
          child: Container(
