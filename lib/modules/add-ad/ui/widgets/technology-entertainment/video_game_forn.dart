...
class VideoGameFormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        CustomDropdown(
          hint: AppLocalization.of(context).translate('game_type'),
          value: null,
          items: ['PS4', 'PS5', 'Xbox', 'PC', 'Switch'],
          onChanged: (_) {},
        ),
        SizedBox(height: 12.h),

        CustomTextField(
          hintText: AppLocalization.of(context).translate('game_name'),
        ),
        SizedBox(height: 12.h),

        CustomTextField(
          hintText: AppLocalization.of(context).translate('version'),
        ),
        SizedBox(height: 12.h),

        _buildRadioRow(
          AppLocalization.of(context).translate('available_online'),
          [
            CustomRadioOption(
              label: AppLocalization.of(context).translate('yes'),
              value: 'yes',
              groupValue: condition,
              onChanged: setCondition,
            ),
            CustomRadioOption(
              label: AppLocalization.of(context).translate('no'),
              value: 'no',
              groupValue: condition,
              onChanged: setCondition,
            ),
