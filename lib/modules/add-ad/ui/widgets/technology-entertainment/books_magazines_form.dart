...
class BooksMagazinesFormSection extends StatelessWidget {
  ...
  const BooksMagazinesFormSection({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('type')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('title')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('author')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('publisherYear')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('language')),
        SizedBox(height: 12.h),
        CustomTextField(hintText: tr('issueNumber')),
        SizedBox(height: 12.h),
        CustomTextField(
