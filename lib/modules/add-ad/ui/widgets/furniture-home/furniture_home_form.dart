...
class FurnitureHomeFormSection extends StatelessWidget {
  ...
  const FurnitureHomeFormSection({
    super.key,
    ...
    return Column(
      children: [
        CustomDropdown(
          ...
          value: null,
          items: [AppLocalization.of(context).translate('beds')],
          onChanged: (_) {},
        ),
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('dimensions'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('material_or_wood_or_fabric'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('purchase_year_or_usage_duration'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
