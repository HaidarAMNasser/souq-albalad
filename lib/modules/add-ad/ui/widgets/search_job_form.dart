...
class SearchJobFormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        CustomTextField(
          hintText: AppLocalization.of(context).translate('job_type'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('education_level'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('previous_experience'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('skills'),
        ),
        SizedBox(height: 12.h),
        CustomDropdown(
          hint: AppLocalization.of(context).translate('working_hours'),
          value: null,
          items: [
            AppLocalization.of(context).translate('morning'),
            AppLocalization.of(context).translate('evening'),
          ],
          onChanged: (_) {},
        ),
        SizedBox(height: 12.h),
        ...
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('preferred_work_location'),
        ),
        SizedBox(height: 12.h),
        GestureDetector(
          onTap: pickImages,
