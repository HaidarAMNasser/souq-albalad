...
class SportFormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CustomTextField(
          hintText: AppLocalization.of(context).translate('enterAdTitle'),
        ),
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('modelVersion'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('sizeCapacityVolume'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('purchaseManufactureYear'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('materialSpecifications'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('specialFeatures'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('enterPrice'),
        ...
        _buildRadioRow('', [
          ...
          CustomRadioOption(
            label: AppLocalization.of(context).translate('notNegotiable'),
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('compatibleCars'),
        ),
        SizedBox(height: 12.h),
        CustomDropdown(
          hint: AppLocalization.of(context).translate('chooseCity'),
          value: city,
          items: cities,
          onChanged: setCity,
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('detailedAddress'),
        ),
        SizedBox(height: 12.h),
        GestureDetector(
          onTap: pickImages,
          child: Container(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(AppLocalization.of(context).translate('adImages')),
                  Icon(
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('phoneNumber'),
          keyboardType: TextInputType.phone,
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('emailAddress'),
