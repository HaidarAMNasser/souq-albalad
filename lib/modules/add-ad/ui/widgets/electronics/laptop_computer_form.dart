...
class LaptopComputerFormSection extends StatelessWidget {
  ...
  const LaptopComputerFormSection({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('device_type'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('processor'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(hintText: AppLocalization.of(context).translate('ram')),
        SizedBox(height: 12.h),
        CustomTextField(
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('graphics_card'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('operating_system'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
