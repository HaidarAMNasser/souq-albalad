...
class LandsFormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 12.h),
        CustomDropdown(
          hint: AppLocalization.of(context).translate('facade'),
          value: null,
          items: [
            AppLocalization.of(context).translate('north'),
            AppLocalization.of(context).translate('south'),
            AppLocalization.of(context).translate('east'),
            AppLocalization.of(context).translate('west'),
          ],
          onChanged: (_) {},
        ),
        SizedBox(height: 12.h),
        CustomDropdown(
          hint: AppLocalization.of(context).translate('land_nature'),
          value: null,
          items: [
            AppLocalization.of(context).translate('flat'),
            AppLocalization.of(context).translate('mountainous'),
            AppLocalization.of(context).translate('agricultural'),
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('street_width'),
          keyboardType: TextInputType.number,
        ),
        SizedBox(height: 12.h),
        CustomTextField(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Icon(Icons.cloud_upload, size: 40.sp),
                ],
              ),
            ),
          ),
