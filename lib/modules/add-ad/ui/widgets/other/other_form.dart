  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('model_or_version'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(
            context,
          ).translate('main_specifications'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(
        ...
        SizedBox(height: 12.h),
        CustomTextField(
          hintText: AppLocalization.of(context).translate('size_or_color'),
        ),
        SizedBox(height: 12.h),
        CustomTextField(
