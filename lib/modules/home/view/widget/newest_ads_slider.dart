...
class NewestAdsSlider extends StatefulWidget {

  final List<ProductBundleModel> products;
  const NewestAdsSlider({required this.products, super.key});

  @override
  State<NewestAdsSlider> createState() => _NewestAdsSliderState();
}

class _NewestAdsSliderState extends State<NewestAdsSlider> {
