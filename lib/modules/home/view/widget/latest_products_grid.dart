...
class LatestProductsGrid extends StatelessWidget {
          ...
          Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildProductItem(products[index], isDark, context);
              },
            ),
          ),
  ...
  Widget _buildProductItem(
      ProductBundleModel product, bool isDark, BuildContext context) {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => CarDetailsScreen(
              id: product.product != null ? product.product!.id ?? 0 : 0,
            ),
          ),
        );
      },
